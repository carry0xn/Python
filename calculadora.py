...
boton_igual = Button(ventana, text="=", width= 13, height= 2, command= lambda: resolver())

#Otros
boton_borrar = Button(ventana, text="AC", width= 5, height= 2, command= lambda: borrar())
boton_punto = Button(ventana, text=".", width= 5, height= 2, command= lambda: click_boton("."))

boton_parentesis_abrir = Button(ventana, text="(", width= 5, height= 2, command= lambda: click_boton("("))
boton_parentesis_cerrar = Button(ventana, text=")", width= 5, height= 2, command= lambda: click_boton(")"))
...
boton_igual.grid(row=5, column=0, columnspan=2, padx=5, pady=5) 
boton_punto.grid(row=5, column=2, padx=5, pady=5)
boton0.grid(row=5, column=3, padx=5, pady=5)
